...
| Surface Router         | Map supported conversations to Surfaces; resolve policy inheritance | `Surface` union type    | DMs, group DMs, and eligible public/private threads are explicit; channel policy limits allowed Agents ([ADR-0018](../decisions/0018-conversation-surface-coverage.md)) |
