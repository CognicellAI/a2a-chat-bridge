...
| ---------------------- | ------------------------------------------------------------------- | ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Workspace Command Core | Execute shared Agent, Session, and Task command contract            | typed commands/results  | Adapters parse and render; explicit direct-message and conversation policies limit agents while platforms govern collaboration ([ADR-0019](../decisions/0019-direct-message-agent-policy.md)) |
