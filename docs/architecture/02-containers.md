...
| ------------------ | ------------------ | ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Discord Adapter    | discord.js v14     | Bot DM and eligible public/private-thread events; commands; mention-gated requests; batched edits | Public/private thread workspaces inherit parent-channel policies; Discord group DMs are unavailable to bots ([ADR-0018](../decisions/0018-conversation-surface-coverage.md))       |
| Slack Adapter      | Slack Bolt v5      | DM/group-DM events; native commands; channel-thread workspaces; Block Kit controls                | DMs use configured agents; explicitly allowlisted group DMs and public/private channels use conversation policies ([ADR-0018](../decisions/0018-conversation-surface-coverage.md)) |
