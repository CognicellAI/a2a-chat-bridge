...
| ------------------ | ------------------ | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Discord Adapter    | discord.js v14     | DM and eligible-thread events; Contact and Session selection; mention-gated requests; batched edits | DMs plus public threads enabled by hot-reloaded channel policies; thread starter/`Manage Threads` controls mutations ([ADR-0011](../decisions/0011-channel-agent-policies.md)) |
