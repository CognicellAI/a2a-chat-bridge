...
C4Deployment
    ...
    Deployment_Node(host, "Self-hosted machine", "user's hardware or VPS — outbound-only") {
        Container(app, "a2a-chat-bridge", "Bun single executable", "Discord adapter + A2A client core")
...
- The machine needs outbound HTTPS to Discord and to whatever hosts the dialed
  A2A agents.
